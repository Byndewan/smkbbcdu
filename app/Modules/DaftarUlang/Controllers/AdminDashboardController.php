...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        if (Auth::user()->is_operator && Auth::user()->major_id) {
            $major = DB::table('core_majors')->where('id', Auth::user()->major_id)->first();
        }
    ...
    public function indexFinance()
    {
        ...
        return view('Keuangan::dashboard.index', compact('grandTotal', 'totalPaidStudents', 'breakdowns', 'major'));
    }
}
